...
#define CPU_MILLIVOLTS {\
	750, 756, 762, 775, 787, 793, 800, 812, 825, 837, 850, 862, 875, 887, 900, 912, 925, 937, 950, 962, 975, 987, 1000, 1012, 1025, 1037, 1050, 1075, 1087, 1100, 1112, 1137, 1150, 1162, 1175, 1187, 1200, 1212, 1237, 1250};
...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  4, 0, MHZ,  51, 102, 102, 153, 204, 204, 255, 306, 306, 357, 408, 408, 459, 510, 612, 612, 663, 714, 765, 816, 816, 867, 918, 959, 1020, 1071, 1122, 1173, 1224, 1275, 1326, 1326, 1357, 1428, 1479, 1530, 1581, 1632, 1683, 1683),
	CPU_DVFS("cpu_g",  4, 1, MHZ,  51, 102, 102, 153, 204, 204, 255, 306, 306, 357, 408, 408, 459, 510, 612, 612, 663, 714, 765, 816, 816, 867, 918, 959, 1020, 1071, 1122, 1173, 1224, 1275, 1326, 1326, 1357, 1428, 1479, 1530, 1581, 1632, 1683, 1683),
	CPU_DVFS("cpu_g",  4, 2, MHZ,  51, 102, 102, 153, 204, 204, 255, 306, 306, 357, 408, 408, 459, 510, 612, 612, 663, 714, 765, 816, 816, 867, 918, 959, 1020, 1071, 1122, 1173, 1224, 1275, 1326, 1326, 1357, 1428, 1479, 1530, 1581, 1632, 1683, 1683),
	CPU_DVFS("cpu_g",  4, 3, MHZ,  51, 102, 102, 153, 204, 204, 255, 306, 306, 357, 408, 408, 459, 510, 612, 612, 663, 714, 765, 816, 816, 867, 918, 959, 1020, 1071, 1122, 1173, 1224, 1275, 1326, 1326, 1357, 1428, 1479, 1530, 1581, 1632, 1683, 1683),
...
static struct dvfs cpu_0_dvfs_table[] = {
	...
	CPU_DVFS("cpu_0",  4, 0, MHZ,  51, 102, 102, 153, 204, 204, 255, 306, 306, 357, 408, 408, 459, 510, 612, 612, 663, 714, 765, 816, 816, 867, 918, 959, 1020, 1071, 1122, 1173, 1224, 1275, 1326, 1326, 1357, 1428, 1479, 1530, 1581, 1632, 1683, 1683),
	CPU_DVFS("cpu_0",  4, 1, MHZ,  51, 102, 102, 153, 204, 204, 255, 306, 306, 357, 408, 408, 459, 510, 612, 612, 663, 714, 765, 816, 816, 867, 918, 959, 1020, 1071, 1122, 1173, 1224, 1275, 1326, 1326, 1357, 1428, 1479, 1530, 1581, 1632, 1683, 1683),
	CPU_DVFS("cpu_0",  4, 2, MHZ,  51, 102, 102, 153, 204, 204, 255, 306, 306, 357, 408, 408, 459, 510, 612, 612, 663, 714, 765, 816, 816, 867, 918, 959, 1020, 1071, 1122, 1173, 1224, 1275, 1326, 1326, 1357, 1428, 1479, 1530, 1581, 1632, 1683, 1683),
	CPU_DVFS("cpu_0",  4, 3, MHZ,  51, 102, 102, 153, 204, 204, 255, 306, 306, 357, 408, 408, 459, 510, 612, 612, 663, 714, 765, 816, 816, 867, 918, 959, 1020, 1071, 1122, 1173, 1224, 1275, 1326, 1326, 1357, 1428, 1479, 1530, 1581, 1632, 1683, 1683),
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", 0, 1, KHZ,        1, 306000, 357000, 408000, 459000,  510000,  510000,  510000,  510000),
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   204000, 306000, 357000, 408000, 459000,  510000,  510000,  510000,  510000),
	CORE_DVFS("cpu_lp", 2, 1, KHZ,   204000, 306000, 357000, 408000, 459000,  510000,  561000,  612000,  612000),
	CORE_DVFS("cpu_lp", 3, 1, KHZ,        1,      1,      1,      1,      1,      1,   459000,  459000,  459000),
	...
	CORE_DVFS("vde",    0, 1, KHZ,        1, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  535500),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  535500),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  535500),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  535500),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),

	CORE_DVFS("vde",    1, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  535500),
	CORE_DVFS("mpe",    1, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  535500),
	CORE_DVFS("2d",     1, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("epp",    1, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  535500),
	CORE_DVFS("3d",     1, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("3d2",    1, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("se",     1, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),

	CORE_DVFS("vde",    2, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("mpe",    2, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("2d",     2, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("epp",    2, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("3d",     2, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("3d2",    2, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("se",     2, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),

	CORE_DVFS("vde",    3, 1, KHZ,        1,      1,      1,       1,      1,      1,  459000,  510000,  612000),
	CORE_DVFS("mpe",    3, 1, KHZ,        1,      1,      1,       1,      1,      1,  459000,  510000,  612000),
	CORE_DVFS("2d",     3, 1, KHZ,   204000, 255000, 306000, 357000, 382500,  408000,  459000,  510000,  612000),
	CORE_DVFS("epp",    3, 1, KHZ,        1,      1,      1,       1,      1,      1,  459000,  510000,  612000),
	CORE_DVFS("3d",     3, 1, KHZ,        1,      1,      1,       1,      1,      1,  459000,  510000,  612000),
	CORE_DVFS("3d2",    3, 1, KHZ,        1,      1,      1,       1,      1,      1,  459000,  510000,  612000),
	CORE_DVFS("se",     3, 1, KHZ,        1,      1,      1,       1,      1,      1,  510000,  561000,  663000),
	...
	CORE_DVFS("cbus",   2, 1, KHZ,   204000, 255000, 306000, 357000, 408000,  459000,  484500,  510000,  612000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1,      1,      1, 459000, 459000,  459000,  459000,  510000,  612000),
